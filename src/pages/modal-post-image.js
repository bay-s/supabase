...
function ModalPostImage(props){
    ...
    return(
<section className={props.data.imgUpload !== '' ? "columns is-multiline p-0 m-0 h-100" : "hide"}>
...
<select className='select is-primary my-2' value={props.data.value} onChange={props.data.selectValue}>
{props.data.selectOption.map(value => {
  ...
  <textarea class="textarea is-light" name='caption' placeholder="Write caption.." onChange={props.data.handlerChange}></textarea>
  </div>
